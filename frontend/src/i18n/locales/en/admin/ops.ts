export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: 'Health thresholds used by the ops dashboard and alerting.',
        slaMinPercent: 'Minimum SLA (%)',
        slaMinPercentHint: 'Below this success rate the service is reported as degraded.',
        ttftP99MaxMs: 'Max TTFT p99 (ms)',
        ttftP99MaxMsHint: 'p99 time-to-first-token above this value is treated as slow.',
        requestErrorRateMaxPercent: 'Max request error rate (%)',
        requestErrorRateMaxPercentHint: 'Client-facing error rate above this value raises an alert.',
        upstreamErrorRateMaxPercent: 'Max upstream error rate (%)',
        upstreamErrorRateMaxPercentHint: 'Upstream provider error rate above this value raises an alert.',
