export default {
    ops: {
      ...
      runtime: {
        ...
        metricThresholdsHint: '运维看板与告警使用的健康阈值。',
        slaMinPercent: 'SLA 最低值（%）',
        slaMinPercentHint: '成功率低于该值时，服务将被标记为降级。',
        ttftP99MaxMs: 'TTFT p99 上限（毫秒）',
        ttftP99MaxMsHint: '首字延迟 p99 超过该值即视为响应缓慢。',
        requestErrorRateMaxPercent: '请求错误率上限（%）',
        requestErrorRateMaxPercentHint: '面向客户端的错误率超过该值将触发告警。',
        upstreamErrorRateMaxPercent: '上游错误率上限（%）',
        upstreamErrorRateMaxPercentHint: '上游提供商错误率超过该值将触发告警。',
