...
const LOGIN_AGREEMENT_STORAGE_KEY = 'mishra_api_login_agreement_consent'
...
const siteName = ref<string>('Mishra Miron API')
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'Mishra Miron API'
